...
def _send_notification_email(
    ...
    body = (
        f"Dear Finance Team,\n\n"
        f"Please find the attached {expense_type} bills for your reference.\n\n"
    ...
    params: resend.Emails.SendParams = {
        ...
        "to": [NOTIFY_TO],
        "subject": f"New Reimbursement Request — {employee_name} ({currency} {amount:.2f})",
        "text": body,
    }
...
async def submit(
    ...
    # Fire notification email non-blocking via BackgroundTasks (GC-safe)
